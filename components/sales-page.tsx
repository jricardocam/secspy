...
export function SalesPage() {
  ...
  return (
    <div className="scrollable-page min-h-screen pb-32" style={{ backgroundColor: "var(--background)", color: "var(--text-primary)" }}>
      
      {/* Hero Section */}
      <section className="relative overflow-hidden px-4 py-16">
        {/* Background effects */}
        <div className="absolute inset-0 opacity-30" style={{ background: "radial-gradient(circle at 50% 0%, rgba(245, 158, 11, 0.08) 0%, transparent 70%)" }} />
      ...
      {/* Problem Section */}
      <section className="px-4 py-12" style={{ borderTop: "1px solid var(--border-inactive)", borderBottom: "1px solid var(--border-inactive)", backgroundColor: "var(--card-bg)" }}>
        <div className="mx-auto max-w-2xl">
          ...
          <div className="space-y-4" style={{ color: "var(--text-secondary)" }}>
            ...
            <p>
              Mientras tanto, tú pagas <span className="font-semibold" style={{ color: "var(--text-primary)" }}>10x más</span> por la misma
      ...
      <section className="px-4 py-12">
        <div className="mx-auto max-w-2xl">
          <h2 className="mb-6 text-center text-2xl font-bold" style={{ color: "var(--text-primary)", fontFamily: '"Bebas Neue", sans-serif' }}>La Solución</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3 rounded-lg p-4" style={{ border: "1px solid var(--border-inactive)", backgroundColor: "var(--card-bg)" }}>
                <Check className="mt-0.5 h-5 w-5 flex-shrink-0" style={{ color: "var(--accent-main)" }} />
                <p style={{ color: "var(--text-primary)" }}>{benefit}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
            {archivos.map((archivo, i) => (
              <div
                ...
                style={{ border: "1px solid var(--border-inactive)", backgroundColor: "var(--background)" }}
              >
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="rounded-lg p-4" style={{ border: "1px solid var(--border-inactive)", backgroundColor: "var(--card-bg)" }}>
      ...
      <section className="px-4 py-12" style={{ borderTop: "1px solid var(--border-inactive)", borderBottom: "1px solid var(--border-inactive)", backgroundColor: "var(--card-bg)" }}>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mb-4 text-2xl font-bold" style={{ color: "var(--text-primary)", fontFamily: '"Bebas Neue", sans-serif' }}>Garantía de Sabor</h2>
      ...
      <section className="px-4 py-12">
        <div className="mx-auto max-w-2xl">
          ...
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="rounded-lg" style={{ border: "1px solid var(--border-inactive)", backgroundColor: "var(--card-bg)" }}>
                <button
                  type="button"
                  onClick={() => toggleFaq(i)}
      ...
      {/* Final CTA */}
      <section className="px-4 py-12" style={{ borderTop: "1px solid var(--border-inactive)", backgroundColor: "var(--card-bg)" }}>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mb-6" style={{ color: "var(--text-secondary)" }}>14 archivos exclusivos. Acceso de por vida. Garantía total.</p>
          ...
          <div className="mb-6 inline-block rounded-lg px-6 py-4" style={{ border: "1px solid rgba(245, 158, 11, 0.3)", backgroundColor: "rgba(245, 158, 11, 0.1)" }}>
            ...
            <p className="text-xs" style={{ color: "var(--text-secondary)" }}>Pago único - Oferta de Lanzamiento</p>
          </div>
        </div>
      </section>

      <footer className="px-4 py-8 text-center" style={{ borderTop: "1px solid var(--border-inactive)", backgroundColor: "var(--background)" }}>
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-4 flex justify-center gap-4 text-[10px]" style={{ color: "var(--text-tertiary)" }}>
            <span className="cursor-pointer hover:opacity-70">Términos y Condiciones</span>
            <span className="cursor-pointer hover:opacity-70">Política de Privacidad</span>
          </div>
        </div>
      </footer>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 p-4 backdrop-blur-sm md:left-auto md:right-auto md:w-[430px]" style={{ borderTop: "1px solid var(--border-inactive)", backgroundColor: "rgba(15, 14, 12, 0.95)" }}>
        <div className="mx-auto max-w-2xl">
          ...
          >
            <Button 
              className="w-full py-6 text-base font-bold tracking-wider hover:opacity-90 transition-all"
              style={{ 
